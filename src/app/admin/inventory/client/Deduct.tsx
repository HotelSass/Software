...
const Deduct = ({ openDeduct, setOpenDeduct ,data}: any) => {
    ...
    const submitForm = async (event: any) => {
        ...
        try {
            const response = await fetch(serverUrl + "/inventory/deductInventory", {
                method: 'POST',
                headers: {
    ...
    return (
        <Modal width={450} open={openDeduct} setOpen={setOpenDeduct} height={400}>
